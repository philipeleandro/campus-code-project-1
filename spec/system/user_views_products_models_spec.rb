...
describe 'User sees product models' do
  ...
  it 'success' do
    ...
    ProductModel.create!(name: 'TV 32', weigth: 8000, width: 70,height: 45, depth: 10, sku: 'TV32-SAMSU-XPT090', supplier: supplier)
    ProductModel.create!(name: 'Notebook', weigth: 2500, width: 35,height: 23, depth: 20, sku: 'NBI3-SAMSU-LUX425', supplier: supplier)
    ...
    expect(page).to have_content('NBI3-SAMSU-LUX425')
  end
